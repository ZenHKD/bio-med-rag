"""
Biomedical Information Retrieval System — Streamlit Demo
Location : src/demo/app.py
Run from project root:  streamlit run src/demo/app.py

Mirrors query.py exactly:
    store    = VectorStore(device=...)
    pipeline = RAGPipeline(store, K, k, reranker_model, llm_model, thinking, max_new_tokens)
    result   = pipeline.run(question)   →  {answer, thinking, retrieved, reranked, sources}
"""
...
# ── Path setup ────────────────────────────────────────────────────────────────
# src/demo/app.py  →  .parent = src/demo  →  .parent.parent = src
...
def load_pipeline(
    _store,  # _ prefix = Streamlit won't try to hash this
    K: int,
    k: int,
    llm_model: str,
    reranker_model: str,
...
# ─────────────────────────────────────────────────────────────────────────────
# Sidebar — mirrors query.py CLI args
# ─────────────────────────────────────────────────────────────────────────────
with st.sidebar:
    ...
    # Show the index/chunks paths for reference
    st.divider()
...
# ─────────────────────────────────────────────────────────────────────────────
# Load pipeline — re-runs only when sidebar values change
# ─────────────────────────────────────────────────────────────────────────────
try:
...
st.caption("Retrieval-Augmented Generation · USTH Group 1 · March 2026")
...
# ─────────────────────────────────────────────────────────────────────────────
# Input — MCQ tab and free-text tab
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Render helpers  (mirror print_result() in query.py)
# ─────────────────────────────────────────────────────────────────────────────
